...
-export_type([
                ...
                output_attrib/0,
                private_attrib/0,
                attrib_value_array/0,
                attrib_value/0,
                config_value_array/0,
                config_value/0,
                input_value_array/0,
                input_value/0,
                output_value_array/0,
                output_value/0,
                private_value_array/0,
                private_value/0,
                link_defs/0,
                link_def/0,
                empty_link/0,
                ...
                block_name/0,
                type_name/0,
                attrib_result_value/0,
                attrib_errors/0,                        
                value/0,
                input_errors/0,
                generic_input_value/0,
                integer_input_value/0,
                float_input_value/0,
                boolean_input_value/0,
                string_input_value/0,
                config_errors/0,
                generic_config_value/0,
                integer_config_value/0,
                float_config_value/0,
                boolean_config_value/0,
                string_config_value/0,
                exec_method/0,
                block_status/0,
                type_group/0
]).
